...
@Component({
  selector: 'app-update-jmn',
  templateUrl: './update-jmn.component.html',
  styleUrls: ['./update-jmn.component.scss']
})
export class UpdateJMNComponent {
  ...
  constructor(
    ...
    private _dialogRef: MatDialogRef<UpdateJMNComponent>,
