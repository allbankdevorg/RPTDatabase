...
@Component({
  selector: 'app-affiliates-rpmodal',
  templateUrl: './affiliates-rpmodal.component.html',
  styleUrls: ['./affiliates-rpmodal.component.scss']
})
export class AffiliatesRPModalComponent implements OnInit{
  ...
  constructor(
    ...
    private _dialogRef: MatDialogRef<AffiliatesRPModalComponent>,
